...
//
{
    ...
    //printf("create hash tables\n");

    createHashTables();

    // --- count number of objects in input file and create them
    //printf("input_countObjects\n");
    input_countObjects();
    //printf("createObjects\n");
    createObjects();

    // --- read project data from input file
    //printf(" input_readData\n");
    input_readData();
    //printf("end input_readData\n");
    if ( ErrorCode ) return;
