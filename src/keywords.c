...
char* OptionWords[]        = { w_FLOW_UNITS,        w_INFIL_MODEL,
    ...
    /* END modification by Alejandro Figueroa | EAWAG */
			       ...
			       //w_UA, w_EXT_UNIT,		
                                 w_HUMIDITY, w_EXT_UNIT, w_GLOBTPAT, w_ASCII_OUT, w_TSBINARY,
...
/* START modification by Alejandro Figueroa | EAWAG */
char* TempUnitsWords[] = {  w_CELSIUS,
                            NULL };
char* HeatRWords[]     = { w_SHR,
                            NULL };
//char* SedimTWords[] = { w_STemp,
 //                         NULL };
/* END modification by Alejandro Figueroa | EAWAG */
