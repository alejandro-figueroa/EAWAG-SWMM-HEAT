...
//
{
    ...
    /* START modification by Alejandro Figueroa | EAWAG */
    if (!IgnoreWTemperature)
        fprintf(Frpt.file, "%10s", TempUnitsWords[WTemperature.units]);
    /* END modification by Alejandro Figueroa | EAWAG */
}
        ...
        if ( k >= 0 )
        {
            ...
            /* START modification by Alejandro Figueroa | EAWAG */
                if (!IgnoreWTemperature)
                {
                    ...
                    fprintf(Frpt.file, " %9.3f", LinkResults[LINK_QUAL + Nobjects[POLLUT]+1]);
                    fprintf(Frpt.file, " %9.3f", LinkResults[LINK_QUAL + Nobjects[POLLUT]+2]);
                }
            }
        /* END modification by Alejandro Figueroa | EAWAG */
            WRITE("");
...
//
{
    ...
    /* START modification by Alejandro Figueroa | EAWAG */
    if (!IgnoreWTemperature)
        fprintf(Frpt.file, "Temperature   Heat_recovery   Sediment_Temperature");
    /* END modification by Alejandro Figueroa | EAWAG */
    ...
    /* START modification by Alejandro Figueroa | EAWAG */
    if (!IgnoreWTemperature)
        fprintf(Frpt.file, "%10s  Heat_recovery  %10s", TempUnitsWords[WTemperature.units], TempUnitsWords[WTemperature.units]);
    /* END modification by Alejandro Figueroa | EAWAG */
    ...
    /* START modification by Alejandro Figueroa | EAWAG */
    if (!IgnoreWTemperature)
        for (i = 0; i < 3; i++) fprintf(Frpt.file, LINE_10);
    /* END modification by Alejandro Figueroa | EAWAG */
}
